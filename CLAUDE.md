...
8. **← CURRENT (steps 9 + 10 now done).** Deploy the dashboard + connect the domain. Not done in the adapter/site sessions — it's an outward-facing action needing the maintainer's `vercel` login and a stable, real multi-protocol site to point at (both now exist).
